...
final GlobalKey<_LivingRoomState> livingRoomKey = GlobalKey<_LivingRoomState>();

class LivingRoom extends StatefulWidget {

  LivingRoom() : super(key: livingRoomKey);

  @override
  State<LivingRoom> createState() => _LivingRoomState();
}

class _LivingRoomState extends State<LivingRoom> with SingleTickerProviderStateMixin{

  late AnimationController _controller;
  late Animation<double> _numberAnimation;

  List<Map<String, dynamic>> devices = [
    {"title": "Smart Lights", "subtitle": "4 devices", "icon": Icons.light_rounded, "isOn": true},
    {"title": "Air Samsung F7", "subtitle": "", "icon": FontAwesomeIcons.airFreshener, "isOn": false},
    {"title": "living Room Tv", "subtitle": "", "icon": Icons.tv_rounded, "isOn": false},
    {"title": "Front Entrance Door", "subtitle": "", "icon": FontAwesomeIcons.doorOpen, "isOn": true},
    {"title": "Power Cord", "subtitle": "", "icon": FontAwesomeIcons.plugCircleBolt, "isOn": true},
  ];
